  ...
  return (
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-gold mb-4">Contact Us</h1>
            ...
            <div className="glass-card p-6 md:p-8 mb-6 md:mb-8">
              ...
              <div className="space-y-5 md:space-y-6">
                <div className="flex items-start">
                  <MapPin className="text-gold mr-3 md:mr-4 mt-1" size={20} />
                  <div>
                ...
                <div className="flex items-start">
                  <Clock className="text-gold mr-3 md:mr-4 mt-1" size={20} />
                  <div>
