  ...
  return (
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-gold mb-4">Book Your Event</h1>
          ...
          >
            <div className="glass-card p-8 mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <Calendar className="text-gold mr-4 mt-1" size={24} />
                  <div>
            ...
            <div className="glass-card p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">Free consultation and menu planning</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-gold/20 p-2 rounded-full mr-3">
                    <div className="w-2 h-2 bg-gold rounded-full"></div>
                  </div>
                  <span className="text-gray-600">Flexible cancellation policy</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-gold/20 p-2 rounded-full mr-3">
                    <div className="w-2 h-2 bg-gold rounded-full"></div>
                  </div>
                  <span className="text-gray-600">Professional event coordination</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-gold/20 p-2 rounded-full mr-3">
                    <div className="w-2 h-2 bg-gold rounded-full"></div>
                  </div>
                  <span className="text-gray-600">Customizable packages for any budget</span>
                </li>
              </ul>
            </div>
          </motion.div>
